 ...
 *
 * <p>Connection settings are bound from the {@code openfga.*} prefix so they can
...
public class OpenFGAConfig {
    ...
    /** Optional authorization model id; when empty the store's latest model is used. */
     ...
     * @throws FgaInvalidParameterException if the supplied configuration is invalid
     */
    @Bean
